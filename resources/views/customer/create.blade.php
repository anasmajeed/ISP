            ...
            <div class="box-body" style="-webkit-box-shadow: 10px 14px 22px -1px rgba(0,0,0,0.49);-moz-box-shadow: 10px 14px 22px -1px rgba(0,0,0,0.49);box-shadow: 10px 14px 22px -1px rgba(0,0,0,0.49);">
              ...
              <div class="form-group">
                ...
                <div class="input-group date col-sm-9">
                  ...
                  <input type="text" name="activation_date" class="form-control" id="datepicker" >
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group date col-sm-9">
                    ...
                    <input type="text" name="mac_address" class="form-control" placeholder="-- : -- : -- : -- : -- : --">
                  </div>
              </div>
              ...
              <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">Package</label>
                  <div class="col-sm-10">
                    <input type="text" name="package" class="form-control" id="inputEmail3" placeholder="-  MB">
                  </div>
              </div>
              <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">Fee</label>
                  <div class="col-sm-10">
                    <input type="number" name="fee" class="form-control" id="inputEmail3" placeholder="Amount">
                  </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group col-sm-9">
                  ...
                  <input type="text" name="cnic" class="form-control" data-inputmask='"mask": "99999-9999999-9"' data-mask>
                </div>
                <!-- /.input group -->
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="input-group col-sm-9">
                  ...
                  <input type="text" name="static_ip" class="form-control" data-inputmask="'alias': 'ip'" data-mask>
                </div>
                <!-- /.input group -->
              </div>
              <div class="form-group">
                ...
                <div class="input-group col-sm-9">
                  ...
                  <input type="text" name="router_ip" class="form-control" data-inputmask="'alias': 'ip'" data-mask>
                </div>
                <!-- /.input group -->
              </div>
              <div class="form-group">
                ...
                <div class="input-group col-sm-9">
                  ...
                  <input type="text" name="client_ip" class="form-control" data-inputmask="'alias': 'ip'" data-mask>
                </div>
                <!-- /.input group -->
              </div>
              <div class="form-group">
